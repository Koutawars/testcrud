...
public class EstudianteController {
	...
	public ResponseEntity<Estudiante> addEstudiante(@RequestBody Estudiante estudiante) throws SQLIntegrityConstraintViolationException {
		Estudiante response;
		try {
			response = estudianteService.createEstudiante(estudiante);
		}catch(Exception e) {
